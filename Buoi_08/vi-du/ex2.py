...
# Lưu ý: Truyền response.content (dạng bytes) để BeautifulSoup tự phát hiện đúng encoding UTF-8 từ HTML
...
for card in soup.select("article.product_pod"):
    ...
    # Trích xuất giá trị số: dùng regex lấy chuỗi số thực an toàn
